...
Não é recomendado criar múltiplas contas. Cada utente deve ter apenas uma conta associada ao seu CNI/documento de identidade. Para empresas, deve ser criada uma conta associada ao CNPJ.
...
### O que significam os diferentes status do meu pedido?
...
### Como saberei o resultado da vistoria?
...
### Posso acessar o sistema de um computador público?

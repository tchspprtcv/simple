...
- **Utentes**: Podem solicitar serviços e acompanhar o status de suas solicitações
...
3. **Módulo de Gestão de Utentes**:
   - Gerencia o cadastro de utentes
   - Associa utentes a pedidos
...
3. **Cidadao**: Representa os utentes que solicitam serviços
...
### 4.3 Módulo de Gestão de Utentes

- **RF-16**: O sistema deve permitir o cadastro de utentes com informações pessoais
- **RF-17**: O sistema deve permitir a consulta de utentes por diferentes critérios
- **RF-18**: O sistema deve permitir a atualização de informações de utentes
- **RF-19**: O sistema deve associar utentes a pedidos
...
**Descrição**: Retorna todos os utentes (paginados).
...
| cpf | String | CPF do utente (único) |
...
2. **Integração com Sistemas de Notificação**:
   - Para envio de SMS ou emails aos utentes

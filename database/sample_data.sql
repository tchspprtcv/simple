...
('DOC-IDENT', 'Documento de Identidade', 'RG, CNH ou outro documento com foto', 'pdf,jpg,png', 5000, true, true),
('CPF', 'CPF', 'Cadastro de Pessoa Física', 'pdf,jpg,png', 5000, true, true),
('COMP-RES', 'Comprovante de Residência', 'Conta de água, luz ou telefone', 'pdf,jpg,png', 5000, true, true),
...
('ecbed590-5882-4c2d-a47c-9009e0c87fc6', 'João Silva', 'joao.silva@prefeitura.gov.br', crypt('senha123', gen_salt('bf')), 1, true, CURRENT_TIMESTAMP - INTERVAL '2 days'),
('e639c09b-72d0-468b-a296-634187bae05f', 'Maria Oliveira', 'maria.oliveira@prefeitura.gov.br', crypt('senha456', gen_salt('bf')), 2, true, CURRENT_TIMESTAMP - INTERVAL '1 day'),
('61eed75a-32dd-452c-a160-e79f44cb7778', 'Carlos Santos', 'carlos.santos@prefeitura.gov.br', crypt('senha789', gen_salt('bf')), 3, true, CURRENT_TIMESTAMP - INTERVAL '3 hours'),
('14174f2b-78d4-43e0-94c7-1c90345773cf', 'Ana Pereira', 'ana.pereira@prefeitura.gov.br', crypt('senha321', gen_salt('bf')), 4, true, CURRENT_TIMESTAMP - INTERVAL '5 hours'),
('31ecc117-43a8-4aa2-ba95-f61601b4a92e', 'Roberto Almeida', 'roberto.almeida@prefeitura.gov.br', crypt('senha654', gen_salt('bf')), 5, true, CURRENT_TIMESTAMP - INTERVAL '1 hour');
...
('eb9a0fb9-87ce-435e-849d-f507cfeaa490', 'Pedro Souza', 'CPF', '123.456.789-00', 'pedro.souza@email.com', '(11) 98765-4321', 'Rua das Flores, 123, Centro'),
('34099715-7083-4ca1-bce1-3e441bb15ede', 'Lucia Ferreira', 'RG', '12.345.678-9', 'lucia.ferreira@email.com', '(11) 91234-5678', 'Av. Principal, 456, Jardim Europa'),
('1e439083-e39b-4471-b8b0-3c9baf9d184c', 'Marcos Ribeiro', 'CPF', '987.654.321-00', 'marcos.ribeiro@email.com', '(11) 92345-6789', 'Rua dos Pinheiros, 789, Vila Nova');
...
('EMAIL_REMETENTE', 'noreply@prefeitura.gov.br', 'Email remetente para notificações', 'STRING', 'EMAIL', true),
